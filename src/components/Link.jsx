                ...
                {songData &&
                    ...
                    songData.downloadUrl.map((song, index) => (
                        <div key={index} className="border">
                            {/* <img src={songData.image[2].url} className="aspect-square w-full md:w-52  rounded-md" alt="" /> */}
                            <div className="min-h-min p-3">
                                <p className="mt-2 w-full text-xs font-semibold leading-tight text-gray-700">
                                    Language: {songData.language}
                                </p>
                                <p className="mt-2 flex-1 text-base font-semibold text-gray-900">Name: {songData.name}</p>
